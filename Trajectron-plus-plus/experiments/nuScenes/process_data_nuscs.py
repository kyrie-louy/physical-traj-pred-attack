...
def process_scene(ns_scene, env, nusc, data_path, target_inst_list):
    ...
    while sample['next']:
        ...
        for annotation_token in annotation_tokens:
            ...
            if 'vehicle' in category and ('parked' in attribute or 'moving' in attribute) and \
    ...
    for node_id in pd.unique(data['node_id']):
        ...
        # if node_id == '0c2959b5e7bd4df680c8ddb1f4e7389c':
        #     print((x + x_min)[14-4:14+1])
        #     print((y + y_min)[14-4:14+1])
        #     print(heading[14-4:14+1])
        #     raise ValueError()
        ...
        # if node_id == '3620feb00d744241a94855f3a8913a78':
        #     print((x+x_min)[14-4:14+1])
        #     print((y + y_min)[14-4:14+1])
        #     print(heading[14-4:14+1])
        #     raise ValueError()
...
def process_data(data_path, version, output_path):
    ...
    for ns_scene_name in tqdm(attack_scene_names):
        ...
        # if not ns_scene_name == 'scene-0103':
        #     continue
    ...
    if len(scenes) > 0:
        ...
        if 'mini' in version:
            mini_string = '_mini'
        data_dict_path = os.path.join(output_path, 'nuScenes_' + 'attack' + mini_string + '_100.pkl')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='/mnt/data/nuscenes')
    ...
    scene_inst_token_path = '/mnt/data/attack_pred/scene_inst_tokens.txt'
    ...
    # attack_scene_names = ['scene-0026']  # for debug
    ...
    ### output ###
    # remove non-continuous scenes from target_scene_inst_tokens
    target_scene_inst_tokens = [t for t in target_scene_inst_tokens if t not in target_scene_inst_blacklist]
    target_scene_inst_tokens.sort()

    with open('/mnt/data/attack_pred/scene_inst_tokens.txt', 'w') as f:
        for item in target_scene_inst_tokens:
            f.write("%s\n" % item)
     ### output ###