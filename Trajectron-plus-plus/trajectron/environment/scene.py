...
class Scene(object):
    def __init__(self, timesteps, map=None, dt=1, name="", frequency_multiplier=1, \
                aug_func=None,  non_aug_scene=None, patch=None, vis_patch=None):
        self.map = map
        ...
        self.patch = patch  # (x, y, x, y)
        self.vis_patch = vis_patch  # region for ego and target vehicle visualization
